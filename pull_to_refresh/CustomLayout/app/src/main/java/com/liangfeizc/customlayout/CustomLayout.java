package com.liangfeizc.customlayout;
 ...
 *
 * Created by liangfeizc on 8/7/15.
 */

@RemoteViews.RemoteView
public class CustomLayout extends ViewGroup {
    /** The amount of space used by children in the lefter gutter. */
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        // These are the top and bottom edges in which we are perfroming layout.
